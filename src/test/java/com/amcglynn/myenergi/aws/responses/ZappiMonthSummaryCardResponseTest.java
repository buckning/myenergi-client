...
class ZappiMonthSummaryCardResponseTest {
    ...
    void testCardResponseReturnsChargeMode() {
        ...
        var response = new ZappiMonthSummaryCardResponse(zappiMonthSummary);
        assertThat(response).hasToString("Usage for February 2022\n" +
                "Imported: 150.0kWh\n" +
                "Exported: 50.0kWh\n" +
