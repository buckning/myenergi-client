...
class GoGreenIntentHandlerTest {
    ...
    void testHandle() {
        ...
        assertThat(ssmlOutputSpeech.getSsml())
                .isEqualTo("<speak>Changed charging mode to Eco+. This may take a few minutes.</speak>");
        ...
        assertThat(simpleCard.getContent()).isEqualTo("Changed charging mode to Eco+. This may take a few minutes.");
